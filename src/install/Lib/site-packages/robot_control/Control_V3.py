...
class RobotControl:
    ...
    def __init__(self):
        ...
        self.lift_ctrl = 0  # 0 -> nothing, 1 -> down, 2 -> up
        self.left_motor_speed = 0  # 0
        self.right_motor_speed = 0  # 0
        self.motor_left_ctrl = 0  # 0 left cw, 1 = left ccw
        self.motor_right_ctrl = 0  # 0 right cw, 1 = right ccw
