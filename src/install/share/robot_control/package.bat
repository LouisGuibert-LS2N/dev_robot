...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\robot_control\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\robot_control\hook\ament_prefix_path.bat"
