...
class PathControl(Node):
    def __init__(self):
        ...
        self.minimal_value_front = 1
        self.minimal_value_left = 5
        self.minimal_value_right = 5
        
        self.ratio_left = self.minimal_value_left / 2.5
        self.ratio_right = self.minimal_value_right / 2.5
